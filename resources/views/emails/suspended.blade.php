...
<head>
    ...
    <title>Akun Organisasi Ditangguhkan</title>
    <style>
        ...
        .reason-box { background: #fef2f2; border-left: 4px solid #ef4444; padding: 15px 20px; margin: 25px 0; border-radius: 0 8px 8px 0; }
        .reason-title { font-weight: 600; color: #991b1b; margin-bottom: 5px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.5px; }
        .reason-text { color: #b91c1c; font-size: 15px; margin: 0; font-weight: 500; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Kami memberitahukan bahwa akun organisasi Anda saat ini telah <strong>ditangguhkan (suspended)</strong> oleh Administrator Sistem MoneFlo.</p>
            ...
            <p>Selama masa penangguhan, anggota organisasi Anda tidak akan dapat mengakses dashboard dan melakukan pencatatan transaksi keuangan. Jika Anda merasa ini adalah kesalahan atau Anda ingin mengaktifkan kembali organisasi Anda, silakan ajukan banding melalui halaman portal yang tersedia saat Anda mencoba login.</p>
            
            <center>
                <a href="{{ url('/') }}" class="button">Ke Portal MoneFlo</a>
            </center>
        </div>
        <div class="footer">
